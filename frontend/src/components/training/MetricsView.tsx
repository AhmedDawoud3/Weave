...
export function MetricsView({ epochs }: MetricsViewProps) {
  ...
  return (
    <div className="space-y-5 max-w-5xl select-none">
      ...
      <div className="bg-[#0c0c0e]/80 border border-primary/10 rounded-xl p-4 shadow-xl">
        ...
        <div className="w-full h-2.5 bg-black/60 rounded-full overflow-hidden border border-white/5 relative">
          <div
            className="h-full bg-gradient-to-r from-primary to-[#40d3b6] shadow-[0_0_12px_rgba(64,211,182,0.3)] transition-all duration-300"
            style={{ width: `${overallPercent}%` }}
          />
        </div>

        <div className="flex justify-between items-center text-[9px] text-muted-foreground uppercase font-bold tracking-wider mt-2">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {/* Status card */}
        <div className="bg-[#0c0c0e]/40 border border-primary/5 rounded-xl p-3 flex flex-col justify-between h-18">
          <span className="text-[8.5px] text-muted-foreground font-black uppercase tracking-wider">Training Status</span>
          ...
          <span className="text-[7.5px] text-muted-foreground/60 uppercase font-semibold">
        ...
        {/* Elapsed time card */}
        <div className="bg-[#0c0c0e]/40 border border-primary/5 rounded-xl p-3 flex flex-col justify-between h-18">
          <span className="text-[8.5px] text-muted-foreground font-black uppercase tracking-wider">Time Elapsed</span>
        ...
        <div className="bg-[#0c0c0e]/40 border border-primary/5 rounded-xl p-3 flex flex-col justify-between h-18">
          <span className="text-[8.5px] text-muted-foreground font-black uppercase tracking-wider">Estimated Time Left</span>
          <span className="text-lg font-black font-mono text-white mt-0.5 leading-tight">
        ...
        {/* Training Speed card */}
        <div className="bg-[#0c0c0e]/40 border border-primary/5 rounded-xl p-3 flex flex-col justify-between h-18">
          <span className="text-[8.5px] text-muted-foreground font-black uppercase tracking-wider">Processing Rate</span>
          <span className="text-lg font-black font-mono text-white mt-0.5 leading-tight">
            {speedDisplay}
          </span>
          <span className="text-[7.5px] text-muted-foreground/60 uppercase font-semibold">
      ...
      <div className="flex justify-between items-center bg-black/40 border border-primary/10 rounded-xl p-2.5">
        ...
        <div className="flex bg-black/60 border border-white/10 rounded-lg p-0.5 h-8 items-center select-none text-[9px] font-black uppercase tracking-widest">
          <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Loss chart */}
        <div className="bg-[#0c0c0e]/40 p-4 rounded-xl border border-primary/5 flex flex-col justify-between relative">
          <div className="flex justify-between items-center mb-2">
            <div className="flex flex-col">
              <span className="text-[10px] text-muted-foreground uppercase font-black tracking-wider">Loss Curve</span>
              <span className="text-[7px] text-muted-foreground/50 uppercase tracking-widest font-extrabold">
