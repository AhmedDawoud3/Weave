...
export function PrivacyPage() {
  ...
  return (
    <div className="min-h-screen bg-[#070709] text-[#e4e4e7] overflow-y-auto selection:bg-primary/30 selection:text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        {/* Back Button */}
        <button
          onClick={() => navigate('/')}
          className="group mb-8 flex items-center gap-2 text-sm font-medium text-[#94a3b8] hover:text-white transition-colors duration-200"
        >
        ...
        <div className="space-y-10">
          ...
          <section className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-2">
              <div className="p-5 rounded-2xl bg-[#0f172a]/50 border border-[#1e293b] space-y-2">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc list-inside pl-4 text-[#94a3b8] space-y-2">
        ...
        {/* Footer */}
        <div className="border-t border-[#1e293b] mt-16 pt-8 text-center text-sm text-[#64748b]">
